...
use crate::text::{FontCollectionHandle, FontCore};
...
pub(crate) struct Config {
    ...
    // Textview
    pub(crate) textview_font: FontCollectionHandle,
    ...
    // Completion
    pub(crate) completion_font: FontCollectionHandle,
    ...
    // Hover
    pub(crate) hover_font: FontCollectionHandle,
